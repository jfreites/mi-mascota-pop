...
export default async function SampleProduct() {
    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="container mx-auto px-4 py-4">
                <a href="/shop" className="text-gray-500 hover:text-pop-purple font-medium flex items-center gap-2 transition">
            ...
            <footer className="bg-gray-100 py-8 text-center">
                <p className="font-bold text-gray-500">Mi Mascota Pop © 2024</p>
            </footer>
        </div>
    )
}