...
const CartSummary = () => {
    ...
    useEffect(() => {
        const calculatedSubtotal = 15 * cartItems.length;
        const calculatedTax = calculatedSubtotal * 0.16;
        const calculatedShipping = 5;
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 space-y-6">
                    ...
                    {cartItems.map((item, index) => {
                        return (
                            <div key={item.timestamp || index} className={`bg-white p-4 rounded-[2rem] shadow-lg flex gap-4 items-center relative overflow-hidden group border-2 border-transparent ${index % 2 === 0 ? "hover:border-pop-pink" : "hover:border-pop-cyan"} transition duration-300`}>
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className="font-bold text-xl">{item.name} Title</h3>
                                        ...
                                        <button className="text-gray-300 hover:text-red-400 hover:bg-red-50 p-2 rounded-full transition cursor-pointer" onClick={() => deleteItem(item)}>
                                    ...
                                    <div className="flex justify-between items-end mt-2">
                                        ...
                                        <p className={`font-bold text-xl ${index % 2 === 0 ? "text-pop-pink" : "text-pop-cyan"}`}>$15.00</p>
                                    </div>
                                </div>
                            </div>
                        )
                ...
                <div className="w-full lg:w-96 shrink-0">
                    <div className="bg-white p-6 rounded-[2.5rem] shadow-xl border-4 border-gray-50 relative overflow-hidden">
                        ...
                        <div className="space-y-4 mb-6 relative z-10">
                            ...
                            <div className="flex justify-between text-gray-600 font-medium">
                                <span>Envío</span>
                                <span className="text-pop-cyan font-bold">${shipping}</span>
                            </div>
                            <div className="flex justify-between text-gray-600 font-medium">
                                <span>IVA (16%)</span>
                                <span>${tax}</span>
