    ...
    return (
        <>
            <p className="text-lg text-gray-600 leading-relaxed">
                Make it truly yours! Customize this bandana with your pet's name or a cute icon.
            </p>
            <div className="bg-white p-6 rounded-[2rem] shadow-lg border-2 border-gray-100 relative overflow-hidden">
                ...
                <div className="flex gap-2 p-1 bg-gray-100 rounded-xl mb-6">
                    <button id="tab-upload" onClick={() => switchTab('upload')} className="flex-1 py-2 rounded-lg font-bold text-sm transition-all shadow-sm bg-white text-pop-purple">Upload Photo</button>
                    <button id="tab-design" onClick={() => switchTab('design')} className="flex-1 py-2 rounded-lg font-bold text-sm transition-all text-gray-500 hover:text-gray-700">Pick Design</button>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <div id="content-upload" className="block animate-fade-in">
                            <label className="block text-sm font-bold text-gray-600 mb-2">Upload your pet's face 📸</label>
                        ...
                        <div id="content-design" className="hidden animate-fade-in">
                            <label className="block text-sm font-bold text-gray-600 mb-2">Choose a sticker ✨</label>
                        ...
                        {/* Text Input */}
                        <div>
                            <label className="block text-sm font-bold text-gray-600 mb-2">Add Text (Name, phrase...)</label>
                    ...
                    <div className="w-full md:w-48 shrink-0">
                        <label className="block text-sm font-bold text-gray-600 mb-2 text-center">Live Preview</label>
